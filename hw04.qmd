---
title: "Homework 4: Simulation-Based Uncertainty Quantification"
...
* Problem 1 asks you to use a moving block bootstrap to estimate the median of extreme water level data.
...
* Fit a linear model (with Gaussian errors) to the data and plot the resulting fit. What is your estimate of the monthly sea-level trend?
* Use the residual-resampling scheme to create 1,000 bootstrap replicates of the data. What is the associated 90% confidence interval for the trend? Is the estimate biased?
* Repeat the analysis using the parametric bootstrap for your Gaussian model. How do your estimates of the 90% confidence interval and bias change?
* Why do you think these two analyses produced (or didn't produce) any differences?
...
* Construct 1,000 bootstrap replicates by adding a moving block bootstrap replicate from the weather-induced variability series (with block length 20) to the harmonic prediction. Use these replicates to compute a 95% confidence interval for the median. What is the bias of the estimator?

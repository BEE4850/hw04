...
* Write a model for the regression in \eqref{eq-model} in the probabilistic programming language of your choice. You'll need to pick some priors for $\alpha$, $\beta$, and $\sigma$. 
